...
Version: 0.4
Plugin URI: http://www.bikes.org.uk/route-finder/wp-routes-plugin/
Description: Add Cycle Routes, Mountain Bike Trails, Running Tracks, Walking Routes and more to your posts and pages.
Author: Bikes.org.uk
Author URI: http://www.bikes.org.uk/

Acknowledgement: Based on an original idea by flavio alberti [http://flavio.alicubi.net/]
...
License:
 Released under the GPL license
  ...
  Copyright 2011 mark taylor (email : mark@bikes.org.uk)
...
define('GPS_EMBED_API_URL',     'http://www.gpsies.com/api.do?key=isnikvszjyaclock&expandResult=true&');
...
define('GPS_EMBED_TRACKTYPES',	'trackType');
...
class GPSiesEmbed extends GPSiesEmbed_Plugin
{
	...
	{
		$this->register_plugin ('GPS', __FILE__);
